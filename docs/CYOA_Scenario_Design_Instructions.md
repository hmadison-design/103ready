...
Each scenario is written for exactly one of three audiences. The voice, context, and pressures are different for each. Never blend them.

### 2a. General Aviation Pilots (Primary Audience)
- **Experience level:** 500–1,000 hours total time. Private, instrument, and/or commercial certificate. May or may not be instrument-current. Likely fly single-engine piston or light twin aircraft.
- **Common aircraft:** Cessna 172/182, Piper PA-28/PA-32, Beechcraft Bonanza, Cirrus SR22, or equivalent.
- **Typical pressures:** Schedule pressure ("I need to be there"), get-there-itis, fuel and weather margins, solo or passenger decision dynamics, self-imposed pressure to perform.
- **Knowledge baseline:** Familiar with FARs, AIM, standard phraseology, basic IFR procedures. May have gaps in CRM (especially as single pilot), risk management, and interpreting nuanced weather.
- **ADM focus:** Go/no-go decisions, in-flight replanning, emergency response, communication with ATC, passenger management, personal minimums.

### 2b. Air Traffic Controllers
- **Experience level:** Certified Professional Controller (CPC) or Developmental Controller in facility training. En route, TRACON, or tower environment.
- **Typical pressures:** Traffic volume, coordination with adjacent facilities, equipment outages, pilot non-compliance, workload saturation, supervisor dynamics.
- **Knowledge baseline:** 7110.65 (ATC Order), facility LOAs, traffic flow procedures. Familiar with standard phraseology and separation standards.
- **ADM focus:** Conflict detection and resolution, workload management, communication clarity, recognizing and declaring a situation before it becomes an emergency, duty of care to pilots.

### 2c. Aviation Maintenance Technicians (AMTs)
- **Experience level:** Certificated A&P mechanic with 3–10 years of experience. May hold an Inspection Authorization (IA). Works in GA or light commercial environment.
- **Typical pressures:** Aircraft-on-ground (AOG) situations, pressure from owners/operators to release aircraft, ambiguous maintenance records, time constraints, parts availability.
- **Knowledge baseline:** FARs Part 43 and 91, applicable maintenance manuals, ADs, service bulletins. Familiar with return-to-service documentation and airworthiness standards.
- **ADM focus:** Airworthiness determination, decision to release or ground an aircraft, documentation integrity, communication with owners, escalating unresolved concerns.

---

## 3. The ADM Requirement

**Every scenario must require genuine aeronautical decision-making.** This is non-negotiable regardless of topic.
...
### 4a. Overall Architecture

Each scenario follows a **branching tree** structure with the following parameters:
...
> B. You call Flight Service to get a more detailed weather briefing before departing.
> C. You delay the flight by two hours and re-evaluate.
> D. You call the destination airport's fixed-base operator to get a local pilot report.

### 4d. Structural Requirements for Decision Depth
...
- This counts as a decision point toward the 4-decision minimum.

**Examples of realistic "didn't help" moments:**
- Attempting a frequency change to contact Flight Service but getting no response (radio dead spot in the mountains)
- Trying a troubleshooting step (leaning the mixture, switching fuel tanks) that doesn't resolve the problem
- Requesting a different approach but being told it's unavailable due to traffic
...
**Ending types (use a mix across any scenario):**

| Type | Description |
|---|---|
| **Full success** | Sound decisions throughout; best achievable outcome |
| **Qualified success** | Mostly sound decisions; one suboptimal choice; outcome acceptable but not ideal |
| **Friction / social cost** | Technically safe outcome with interpersonal or logistical consequences (irritated passengers, missed event, wasted trip) |
| **Delay / diversion** | Safe but off-plan outcome; learner lands short, waits, or turns back |
| **Regulatory failure** | No physical danger, but regulatory violation; certificate or enforcement consequences |
| **Off-airport landing** | Forced landing outside of an airport environment; aircraft may be damaged; occupants survive |
| **Aircraft damage** | Survivable incident with significant aircraft damage |
| **Fatal/catastrophic** | Multiple poor decisions across several decision points lead to an accident; used very sparingly |

**Debrief structure** (appears at every ending, separated from the story by a divider):
1. **What happened:** One paragraph narrative summary of the outcome and why.
2. **ADM analysis:** Name the decision(s) that most influenced the outcome. Identify any hazardous attitudes present.
3. **What good judgment looks like here:** Without preaching, explain what the optimal decision process would have been. Reference applicable regulations or industry standards only when directly relevant.
4. **Key takeaway:** One or two sentences. The lesson the learner should carry out the door.

---

## 5. Scenario Tone and Characters
...
- Use the phrase "Are you sure?" or any functional equivalent
- Soften or harden the tone to signal approval or disapproval
...
The first passage tells the pilot exactly where they are. The second tells them they made a mistake and implies they need to compensate. The first is a training tool. The second is a test answer key.
...
**Write short sentences at critical moments.** Sentence rhythm is a tool. Long, flowing prose feels reflective and calm. Short sentences feel urgent.

> "The stall horn sounds. You're in a 35-degree left bank. The runway is at your two o'clock, maybe a quarter mile. You are low."

**Use the environment as a clock.** Rather than saying "you are running out of time," describe the environment in ways that convey time passing: the fuel gauge that has just crossed a threshold, the clouds that have closed off the valley behind you, the sun that is now below the ridgeline. Let the learner feel the closing window without being told it's closing.
...
- VFR into IMC (spatial disorientation, escape maneuvering)
- Fuel management and emergency planning
- Engine failure / partial power loss
- Electrical failures and avionics-off procedures
- Cross-country planning and diversion decisions
- Night operations and environmental awareness
- Passenger management and external pressure
- Lost communications with ATC
- Airspace violations and NOTAM compliance
- Medical emergencies and incapacitation
- Runway incursions and surface operations
- Mountain / terrain flying
- Aircraft performance and weight & balance margins

### For Air Traffic Controllers:
- Traffic conflict identification and resolution
- Separation standard application under pressure
- Pilot deviation response and coordination
- Emergency handling (7700 squawk, NORDO, distress call)
- Equipment failure during high-traffic periods
- Coordination failures between facilities
- Workload management and task prioritization
- Runway incursion prevention
- Lost comms with IFR aircraft
- Weather deviation requests and traffic management

### For Aviation Maintenance Technicians:
- Airworthiness determination with incomplete records
- Return-to-service decisions under owner pressure
- AD (Airworthiness Directive) compliance verification
- Logbook and documentation integrity
- Unscheduled maintenance discovery (pre-flight finding, discrepancy)
- Parts substitution and approved data
- Signing off work you did not perform (ethical scenarios)
- Fuel contamination and systems checks
- Annual inspection judgment calls
- Communication with owners about grounded aircraft
...
- Aircraft types, ATC procedures, and maintenance standards must be accurate and consistent with current FARs, AIM, and applicable Orders.
- Weather scenarios must use real METAR/TAF formats, real weather minimums, and realistic forecast language.
- If citing a regulation, cite the correct part and section (e.g., 14 CFR 91.155, not "the FAA says…").
...
## 10. Twine Implementation Notes

These scenarios are designed for publication on 103ready.com via **Twine**, an open-source, browser-based tool for creating interactive, non-linear stories. Twine exports directly to standalone HTML files suitable for web hosting.

### Recommended Story Format
Use **SugarCube 2** as the Twine story format. It offers:
- The most robust macro library for conditional logic and variables
- Easy state tracking (track choices made, count errors, display conditional debrief content)
- Strong browser compatibility
- Active community and documentation at twinery.org
...
/* In a passage where a poor decision was made: */
<<set $badchoices to $badchoices + 1>>

/* In the debrief: */
<<if $badchoices gte 3>>
  This outcome reflects a chain of compounding errors...
<<elseif $badchoices eq 1>>
  One critical decision significantly altered this outcome...
<<else>>
  Your decision-making throughout this scenario was sound...
<</if>>
```

### Timed Decision Passages
For the rare passages where a time limit applies:
```
/* Display a countdown and auto-advance after N seconds */
<<timed 30s>><<goto "Passage-NoAction">><</timed>>
```
...
The platform will eventually support audio, images, and video. Design passage text with this in mind:
- Leave room for an ambient audio cue (engine sound, ATC traffic, weather) at the top of each passage
- Note in the scenario development file where a cockpit image or instrument panel screenshot would reinforce the situation
- Flag passages where a short video clip (e.g., an actual PIREP, cockpit footage, accident reconstruction) could be embedded
...
## 11. Scenario Header Template

Every scenario file should begin with a standardized metadata block (as a Twine `StoryInit` passage or an introductory notes document):

```
SCENARIO TITLE:
AUDIENCE:               [Pilot / ATC / AMT]
TONE:                   [Professional / Entertainer]
PRIMARY TOPIC:
SECONDARY TOPIC:        [if applicable]
AIRCRAFT/EQUIPMENT:     [e.g., Cessna 182T with G1000]
SETTING:                [Airport, route, time of day, season]
WEATHER:                [Brief summary]
ADM THEMES:             [e.g., Get-there-itis, self-imposed pressure, confirmation bias]
...
- [ ] If Entertainer tone: no fatal outcomes; all endings are embarrassing, inconvenient, or humiliating
- [ ] If Entertainer tone: narrator voice is consistently sarcastic/comedic throughout
- [ ] "Didn't help, didn't hurt" decision points used sparingly (1–2 per scenario max) and only where realistic

**Consequences and Outcomes**
- [ ] Most bad-outcome paths result in realistic, non-fatal consequences (passenger friction, delay, diversion, off-airport landing, regulatory consequence)
- [ ] A single poor choice rarely terminates the scenario fatally
- [ ] Suboptimal choices typically offer (without signaling) a recovery opportunity at the next decision point
- [ ] Fatal endings exist but are rare, requiring a deliberate chain of the worst available choices

**Narrative Neutrality**
- [ ] No intermediate passage signals that a mistake was made
...
- [ ] Incomplete or conflicting information appears somewhere in the scenario
- [ ] At least one passage uses short sentence rhythm to convey urgency
- [ ] Environmental cues (terrain, fuel state, time of day, clouds) function as implicit time pressure
- [ ] If a passenger is present, they speak at least once in a way that adds authentic social pressure
- [ ] If timed decisions are used, the learner is warned at the scenario start and at the passage header

**Structure**
- [ ] Minimum 4 decision points on every playthrough path
- [ ] No path short-circuits to an ending before the 4th decision point
- [ ] At least one counterintuitive-but-correct choice exists in the scenario
- [ ] Ambiguous or conflicting information present at or before the first major decision
- [ ] 10–30 total distinct paths
- [ ] No dead ends except at ending passages
- [ ] Endings include a mix of types (see Section 4d)
- [ ] All passages are named descriptively
- [ ] Variables initialized in StoryInit and reset correctly

**Writing**
- [ ] Second person, present tense throughout narrative passages
- [ ] ATC communications written in correct verbatim format
- [ ] Terminology is correct and consistent
- [ ] Tone is respectful of learner expertise
- [ ] Reading level is appropriate for a professional audience (clear, direct, no jargon inflation)

**Technical and Media**
- [ ] HTML output tested in Chrome, Safari, and mobile browsers
- [ ] Font size readable on tablet and phone
- [ ] "Return to Start" link present on all endings
- [ ] Media placeholder notes added where audio/image/video would enhance a passage
- [ ] Scenario metadata header completed

---

## 13. What These Scenarios Are Not
...
## 14. Continuity Maintenance Rules

Branching narratives are fragile. A single broken promise between a link and its destination destroys an entire branch's credibility as an educational tool. These rules are mandatory for all edits to existing scenarios.
...
- If the destination only performs one of two promised actions and offers the second as a choice, the link text must be rewritten to only promise the first.

**Test:** Read the link text aloud, then read the first paragraph of the destination. Does the destination deliver on every verb in the link? If not, fix the link or fix the destination.

### 14b. Convergence Point Integrity

A convergence point is any passage reachable from two or more paths. These are the most dangerous points for continuity errors.

- Convergence point text must be **true for every incoming path**. Never assume a specific upstream choice.
- Use `<<if>>` conditionals for path-specific details when the narrative needs to acknowledge different upstream states.
- If a convergence point's text says "Your radio is still wrong," verify that the radio IS wrong on every path that reaches this passage.
- When editing ANY passage upstream of a convergence point, re-read the convergence point text and every other incoming link to confirm they all still work.

### 14c. Upstream Edit Cascade

Any edit to a passage requires tracing forward through every downstream passage it connects to, checking:

1. Does the edited passage's outgoing link text still match each destination?
2. Do any destination passages (especially convergence points) contain text that now contradicts the edit?
3. Do state variables ($radioEstablished, $badchoices, etc.) remain consistent with the narrative at every downstream point?
...
Before making any edit to a .twee file:

1. Run the continuity audit script to get the current link map and identify convergence points
2. Identify all convergence points downstream of the planned edit
3. Read every incoming link to each affected convergence point
4. Make the edit
5. Re-check all downstream passages and convergence points for narrative consistency
6. Re-run the audit script to confirm 0 broken links, 0 orphan passages
7. Verify conditional UI elements appear consistently across all relevant passages
